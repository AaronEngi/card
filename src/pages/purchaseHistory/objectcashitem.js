...
export class Objectcashitem extends React.Component {
			...
			<Cells>
              ...
              <Cell>
               ...
               <Cell> 
               	<CellBody>
               		<CellsTitle>
               		<Link to={{ pathname: '/objectcashinfo', query: { showAge: this.props.purchaseDate } }} activeClassName="active">
